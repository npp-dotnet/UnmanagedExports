...
// Type: RGiesecke.DllExport.DllExportWeaver
...
namespace RGiesecke.DllExport
{
  ...
  public sealed class DllExportWeaver : HasServiceProvider
  {
    ...
    {
      using (this.GetNotifier().CreateContextName((object) this, nameof (RunIlAsm)))
      {
    ...
    {
      using (this.GetNotifier().CreateContextName((object) this, nameof (PrepareIlAsm)))
      {
    ...
    {
      using (this.GetNotifier().CreateContextName((object) this, nameof (RunIlDasm)))
      {
